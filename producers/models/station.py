...
class Station(Producer):
    ...
    def __init__(self, station_id, name, color, direction_a=None, direction_b=None):
        ...
        # Creating a new topic per every station.{station_name}
        topic_name = f"com.cta.stations.arrivals.{station_name}"
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        try:
                ...
                #logger.info(f"Message of {self.topic_name} + {data}")                
            ...
            logger.info(f"failed to send arrival mesage of train id  {train.train_id} for the topic {self.topic_name}: {ex}")
